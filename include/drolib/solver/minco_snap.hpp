...
class MincoSnap {
 ...
 public:
  ...
  void setParameters(const Eigen::MatrixXd &inPs, const Eigen::VectorXd &ts) {
    ...
    b_eigen.row(0) = headPVAJ.col(0).transpose();
    b_eigen.row(1) = headPVAJ.col(1).transpose();
    b_eigen.row(2) = headPVAJ.col(2).transpose();
    b_eigen.row(3) = headPVAJ.col(3).transpose();
    ...
    for (int i = 0; i < N - 1; i++) {
      ...
      A_eigen(8 * i + 4, 8 * i + 4) = 24.0;
      A_eigen(8 * i + 4, 8 * i + 5) = 120.0 * T1(i);
      A_eigen(8 * i + 4, 8 * i + 6) = 360.0 * T2(i);
      A_eigen(8 * i + 4, 8 * i + 7) = 840.0 * T3(i);
      A_eigen(8 * i + 4, 8 * i + 12) = -24.0;
      A_eigen(8 * i + 5, 8 * i + 5) = 120.0;
      A_eigen(8 * i + 5, 8 * i + 6) = 720.0 * T1(i);
      A_eigen(8 * i + 5, 8 * i + 7) = 2520.0 * T2(i);
      A_eigen(8 * i + 5, 8 * i + 13) = -120.0;
      A_eigen(8 * i + 6, 8 * i + 6) = 720.0;
      A_eigen(8 * i + 6, 8 * i + 7) = 5040.0 * T1(i);
      A_eigen(8 * i + 6, 8 * i + 14) = -720.0;
      A_eigen(8 * i + 7, 8 * i) = 1.0;
      A_eigen(8 * i + 7, 8 * i + 1) = T1(i);
      A_eigen(8 * i + 7, 8 * i + 2) = T2(i);
      A_eigen(8 * i + 7, 8 * i + 3) = T3(i);
      A_eigen(8 * i + 7, 8 * i + 4) = T4(i);
      A_eigen(8 * i + 7, 8 * i + 5) = T5(i);
      A_eigen(8 * i + 7, 8 * i + 6) = T6(i);
      A_eigen(8 * i + 7, 8 * i + 7) = T7(i);
      A_eigen(8 * i + 8, 8 * i) = 1.0;
      A_eigen(8 * i + 8, 8 * i + 1) = T1(i);
      A_eigen(8 * i + 8, 8 * i + 2) = T2(i);
      A_eigen(8 * i + 8, 8 * i + 3) = T3(i);
      A_eigen(8 * i + 8, 8 * i + 4) = T4(i);
      A_eigen(8 * i + 8, 8 * i + 5) = T5(i);
      A_eigen(8 * i + 8, 8 * i + 6) = T6(i);
      A_eigen(8 * i + 8, 8 * i + 7) = T7(i);
      A_eigen(8 * i + 8, 8 * i + 8) = -1.0;
      A_eigen(8 * i + 9, 8 * i + 1) = 1.0;
      A_eigen(8 * i + 9, 8 * i + 2) = 2.0 * T1(i);
      A_eigen(8 * i + 9, 8 * i + 3) = 3.0 * T2(i);
      A_eigen(8 * i + 9, 8 * i + 4) = 4.0 * T3(i);
      A_eigen(8 * i + 9, 8 * i + 5) = 5.0 * T4(i);
      A_eigen(8 * i + 9, 8 * i + 6) = 6.0 * T5(i);
      A_eigen(8 * i + 9, 8 * i + 7) = 7.0 * T6(i);
      A_eigen(8 * i + 9, 8 * i + 9) = -1.0;
      A_eigen(8 * i + 10, 8 * i + 2) = 2.0;
      A_eigen(8 * i + 10, 8 * i + 3) = 6.0 * T1(i);
      A_eigen(8 * i + 10, 8 * i + 4) = 12.0 * T2(i);
      A_eigen(8 * i + 10, 8 * i + 5) = 20.0 * T3(i);
      A_eigen(8 * i + 10, 8 * i + 6) = 30.0 * T4(i);
      A_eigen(8 * i + 10, 8 * i + 7) = 42.0 * T5(i);
      A_eigen(8 * i + 10, 8 * i + 10) = -2.0;
      A_eigen(8 * i + 11, 8 * i + 3) = 6.0;
      A_eigen(8 * i + 11, 8 * i + 4) = 24.0 * T1(i);
      A_eigen(8 * i + 11, 8 * i + 5) = 60.0 * T2(i);
      A_eigen(8 * i + 11, 8 * i + 6) = 120.0 * T3(i);
      A_eigen(8 * i + 11, 8 * i + 7) = 210.0 * T4(i);
      A_eigen(8 * i + 11, 8 * i + 11) = -6.0;

      b.row(8 * i + 7) = inPs.col(i).transpose();
      b_eigen.row(8 * i + 7) = inPs.col(i).transpose();
    }
    ...
    A_eigen(8 * N - 4, 8 * N - 8) = 1.0;
    A_eigen(8 * N - 4, 8 * N - 7) = T1(N - 1);
    A_eigen(8 * N - 4, 8 * N - 6) = T2(N - 1);
    A_eigen(8 * N - 4, 8 * N - 5) = T3(N - 1);
    A_eigen(8 * N - 4, 8 * N - 4) = T4(N - 1);
    A_eigen(8 * N - 4, 8 * N - 3) = T5(N - 1);
    A_eigen(8 * N - 4, 8 * N - 2) = T6(N - 1);
    A_eigen(8 * N - 4, 8 * N - 1) = T7(N - 1);
    A_eigen(8 * N - 3, 8 * N - 7) = 1.0;
    A_eigen(8 * N - 3, 8 * N - 6) = 2.0 * T1(N - 1);
    A_eigen(8 * N - 3, 8 * N - 5) = 3.0 * T2(N - 1);
    A_eigen(8 * N - 3, 8 * N - 4) = 4.0 * T3(N - 1);
    A_eigen(8 * N - 3, 8 * N - 3) = 5.0 * T4(N - 1);
    A_eigen(8 * N - 3, 8 * N - 2) = 6.0 * T5(N - 1);
    A_eigen(8 * N - 3, 8 * N - 1) = 7.0 * T6(N - 1);
    A_eigen(8 * N - 2, 8 * N - 6) = 2.0;
    A_eigen(8 * N - 2, 8 * N - 5) = 6.0 * T1(N - 1);
    A_eigen(8 * N - 2, 8 * N - 4) = 12.0 * T2(N - 1);
    A_eigen(8 * N - 2, 8 * N - 3) = 20.0 * T3(N - 1);
    A_eigen(8 * N - 2, 8 * N - 2) = 30.0 * T4(N - 1);
    A_eigen(8 * N - 2, 8 * N - 1) = 42.0 * T5(N - 1);
    A_eigen(8 * N - 1, 8 * N - 5) = 6.0;
    A_eigen(8 * N - 1, 8 * N - 4) = 24.0 * T1(N - 1);
    A_eigen(8 * N - 1, 8 * N - 3) = 60.0 * T2(N - 1);
    A_eigen(8 * N - 1, 8 * N - 2) = 120.0 * T3(N - 1);
    A_eigen(8 * N - 1, 8 * N - 1) = 210.0 * T4(N - 1);
    ...
    b_eigen.row(8 * N - 4) = tailPVAJ.col(0).transpose();
    b_eigen.row(8 * N - 3) = tailPVAJ.col(1).transpose();
